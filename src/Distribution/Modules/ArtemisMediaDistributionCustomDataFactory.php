...
{
    public const string ARTICLE_WEB_URL = 'articleWebUrl';
    public const string ARTICLE_ADMIN_URL = 'articleAdminUrl';
    public const string MEDIA_ADMIN_URL = 'mediaAdminUrl';
