...
final class Version20221213104058 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asset_has_file (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', asset_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', image_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', audio_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', video_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', document_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', version_title VARCHAR(255) NOT NULL, is_default TINYINT(1) NOT NULL, INDEX IDX_53A8F7CF5DA1941 (asset_id), UNIQUE INDEX UNIQ_53A8F7CF3DA5256D (image_id), UNIQUE INDEX UNIQ_53A8F7CF3A3123C7 (audio_id), UNIQUE INDEX UNIQ_53A8F7CF29C1004E (video_id), UNIQUE INDEX UNIQ_53A8F7CFC33F7837 (document_id), INDEX IDX_version_title (version_title), INDEX IDX_default (is_default), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE audio_file (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', attributes_duration DOUBLE PRECISION NOT NULL, attributes_codec_name VARCHAR(64) NOT NULL, attributes_bitrate INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE image_file (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', image_attributes_ratio_width INT NOT NULL, image_attributes_ratio_height INT NOT NULL, image_attributes_width INT NOT NULL, image_attributes_height INT NOT NULL, image_attributes_rotation SMALLINT NOT NULL, image_attributes_most_dominant_color VARCHAR(255) NOT NULL COMMENT \'(DC2Type:ColorType)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
