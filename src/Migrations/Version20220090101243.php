...
final class Version20220090101243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE custom_form (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_by_id INT DEFAULT NULL, modified_by_id INT DEFAULT NULL, ext_system_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modified_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', dtype VARCHAR(255) NOT NULL, asset_type VARCHAR(255) DEFAULT NULL, resource_key VARCHAR(255) DEFAULT NULL, INDEX IDX_53FE35B2B03A8386 (created_by_id), INDEX IDX_53FE35B299049ECE (modified_by_id), INDEX IDX_53FE35B2E961F7A (ext_system_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE distribution (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_by_id INT DEFAULT NULL, modified_by_id INT DEFAULT NULL, notify_to_id INT DEFAULT NULL, asset_file_id VARCHAR(36) NOT NULL, asset_id VARCHAR(36) NOT NULL, ext_id VARCHAR(512) NOT NULL, distribution_service VARCHAR(128) NOT NULL, status VARCHAR(255) NOT NULL, fail_reason VARCHAR(255) NOT NULL, distribution_data JSON NOT NULL, publish_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modified_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', dtype VARCHAR(255) NOT NULL, texts_title VARCHAR(255) DEFAULT NULL, texts_description VARCHAR(5000) DEFAULT NULL, texts_author VARCHAR(256) DEFAULT NULL, texts_keywords JSON DEFAULT NULL, privacy VARCHAR(255) DEFAULT NULL, channel_id VARCHAR(32) DEFAULT NULL, playlist VARCHAR(64) DEFAULT NULL, language VARCHAR(20) DEFAULT NULL, flags_embeddable TINYINT(1) DEFAULT NULL, flags_for_kids TINYINT(1) DEFAULT NULL, flags_notify_subscribers TINYINT(1) DEFAULT NULL, texts_ext_rss_id VARCHAR(256) DEFAULT NULL, texts_free_url VARCHAR(2048) DEFAULT NULL, texts_premium_url VARCHAR(2048) DEFAULT NULL, texts_authors JSON DEFAULT NULL, texts_rubric_id INT DEFAULT NULL, texts_episode_id VARCHAR(36) DEFAULT NULL, texts_podcast_id VARCHAR(36) DEFAULT NULL, attributes_duration INT DEFAULT NULL, attributes_premium_duration INT DEFAULT NULL, flags_create_article TINYINT(1) DEFAULT NULL, flags_bonus_episode TINYINT(1) DEFAULT NULL, INDEX IDX_A4483781B03A8386 (created_by_id), INDEX IDX_A448378199049ECE (modified_by_id), INDEX IDX_A448378112433204 (notify_to_id), INDEX IDX_asset_file_id (asset_file_id), INDEX IDX_asset_id (asset_id), INDEX IDX_asset_file_id_distribution_service (asset_file_id, distribution_service), INDEX IDX_status (status), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE podcast (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', licence_id INT DEFAULT NULL, image_preview_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', created_by_id INT DEFAULT NULL, modified_by_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modified_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', texts_title VARCHAR(128) NOT NULL, texts_description VARCHAR(2000) NOT NULL, dates_import_from DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', attributes_rss_url VARCHAR(2048) DEFAULT NULL, attributes_file_slot VARCHAR(128) DEFAULT NULL, attributes_last_import_status VARCHAR(255) NOT NULL, attributes_mode VARCHAR(255) NOT NULL, INDEX IDX_D7E805BD26EF07C9 (licence_id), UNIQUE INDEX UNIQ_D7E805BDA13A78ED (image_preview_id), INDEX IDX_D7E805BDB03A8386 (created_by_id), INDEX IDX_D7E805BD99049ECE (modified_by_id), INDEX IDX_name (attributes_mode), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE podcast_episode (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', image_preview_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', podcast_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', asset_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', created_by_id INT DEFAULT NULL, modified_by_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modified_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', position SMALLINT NOT NULL, dates_publication_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', attributes_rss_url VARCHAR(2048) NOT NULL, attributes_rss_id VARCHAR(256) NOT NULL, attributes_last_import_status VARCHAR(255) NOT NULL, attributes_season_number SMALLINT UNSIGNED DEFAULT NULL, attributes_episode_number SMALLINT UNSIGNED DEFAULT NULL, flags_from_rss TINYINT(1) NOT NULL, texts_title VARCHAR(255) NOT NULL, texts_description LONGTEXT NOT NULL, texts_raw_description LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_77EB2BD0A13A78ED (image_preview_id), INDEX IDX_77EB2BD0786136AB (podcast_id), INDEX IDX_77EB2BD05DA1941 (asset_id), INDEX IDX_77EB2BD0B03A8386 (created_by_id), INDEX IDX_77EB2BD099049ECE (modified_by_id), INDEX IDX_podcast_position (podcast_id, position), INDEX IDX_position (position), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
