...
final class Version20220100100315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE distribution (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_by_id INT DEFAULT NULL, modified_by_id INT DEFAULT NULL, notify_to_id INT DEFAULT NULL, asset_file_id VARCHAR(36) NOT NULL, asset_id VARCHAR(36) NOT NULL, ext_id VARCHAR(512) NOT NULL, distribution_service VARCHAR(128) NOT NULL, status VARCHAR(255) NOT NULL, fail_reason VARCHAR(255) NOT NULL, distribution_data JSON NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modified_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', dtype VARCHAR(255) NOT NULL, texts_title VARCHAR(128) DEFAULT NULL, texts_description VARCHAR(5000) DEFAULT NULL, texts_author VARCHAR(256) DEFAULT NULL, texts_keywords JSON DEFAULT NULL, privacy VARCHAR(255) DEFAULT NULL, publish_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', channel_id VARCHAR(32) DEFAULT NULL, playlist VARCHAR(64) DEFAULT NULL, language INT DEFAULT NULL, flags_embeddable TINYINT(1) DEFAULT NULL, flags_for_kids TINYINT(1) DEFAULT NULL, flags_notify_subscribers TINYINT(1) DEFAULT NULL, custom_data JSON DEFAULT NULL, rss_url VARCHAR(2048) DEFAULT NULL, texts_authors JSON DEFAULT NULL, INDEX IDX_A4483781B03A8386 (created_by_id), INDEX IDX_A448378199049ECE (modified_by_id), INDEX IDX_A448378112433204 (notify_to_id), INDEX IDX_asset_file_id (asset_file_id), INDEX IDX_asset_id (asset_id), INDEX IDX_asset_file_id_distribution_service (asset_file_id, distribution_service), INDEX IDX_status (status), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE podcast_episode (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', image_preview_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', podcast_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', asset_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', created_by_id INT DEFAULT NULL, modified_by_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modified_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', position SMALLINT NOT NULL, dates_publication_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', attributes_ext_id VARCHAR(256) NOT NULL, attributes_season_number SMALLINT UNSIGNED DEFAULT NULL, attributes_episode_number SMALLINT UNSIGNED DEFAULT NULL, texts_title VARCHAR(255) NOT NULL, texts_description LONGTEXT NOT NULL, texts_raw_description LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_77EB2BD0A13A78ED (image_preview_id), INDEX IDX_77EB2BD0786136AB (podcast_id), INDEX IDX_77EB2BD05DA1941 (asset_id), INDEX IDX_77EB2BD0B03A8386 (created_by_id), INDEX IDX_77EB2BD099049ECE (modified_by_id), INDEX IDX_podcast_position (podcast_id, position), INDEX IDX_position (position), INDEX IDX_title_licence_id (texts_title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT NOT NULL, selected_licence_id INT DEFAULT NULL, created_by_id INT DEFAULT NULL, modified_by_id INT DEFAULT NULL, api_token VARCHAR(255) DEFAULT NULL, permissions JSON NOT NULL, allowed_asset_external_providers JSON NOT NULL, allowed_distribution_services JSON NOT NULL, email VARCHAR(256) NOT NULL, roles JSON NOT NULL, enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modified_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', first_name VARCHAR(120) NOT NULL, last_name VARCHAR(120) NOT NULL, INDEX IDX_8D93D649116F432A (selected_licence_id), INDEX IDX_8D93D649B03A8386 (created_by_id), INDEX IDX_8D93D64999049ECE (modified_by_id), UNIQUE INDEX UNIQ_email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE podcast ADD CONSTRAINT FK_D7E805BDA13A78ED FOREIGN KEY (image_preview_id) REFERENCES image_preview (id)');
        ...
        $this->addSql('ALTER TABLE podcast_episode ADD CONSTRAINT FK_77EB2BD0A13A78ED FOREIGN KEY (image_preview_id) REFERENCES image_preview (id)');
        ...
        $this->addSql('ALTER TABLE video_file ADD CONSTRAINT FK_8B086BCCA13A78ED FOREIGN KEY (image_preview_id) REFERENCES image_preview (id)');
