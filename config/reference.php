 ...
 *     }>,
 * }
 * @psalm-type AnzuSystemsCoreDamConfig = array{
 *     settings?: array{
 *         user_entity_class?: scalar|null, // Default: "App\\Entity\\User"
 *         api_domain: scalar|null,
 *         redirect_domain: scalar|null,
 *         notifications?: bool|array{
 *             enabled?: bool, // Default: true
 *             topic?: scalar|null,
 *             gps_config?: array{
 *                 transport?: scalar|null, // Default: "rest"
 *                 credentials?: mixed,
 *             },
 *         },
 *         unsplash_api_client_host: scalar|null, // Default: "https://api.unsplash.com"
 *         jw_player_api_client_host: scalar|null, // Default: "https://api.jwplayer.com"
 *         jw_player_cdn_api_client_host: scalar|null, // Default: "https://cdn.jwplayer.com"
 *         elastic_index_prefix: scalar|null,
 *         elastic_language_dictionaries?: list<scalar|null>,
 *         youtube_api_key?: scalar|null, // Default: ""
 *         distribution_auth_redirect_url: scalar|null,
 *         default_ext_system_id: int, // Default ExtSystem:id
 *         default_asset_licence_id: int, // Default AssetLicence:id which belongs to specified ExtSystem
 *         allow_select_ext_system?: bool, // Default: false
 *         allow_select_licence?: bool, // Default: false
 *         admin_allow_list_name: scalar|null,
 *         max_bulk_item_count: scalar|null,
 *         acl_check_enabled?: bool, // Default: true
 *         app_redis: scalar|null,
 *         cache_redis: scalar|null,
 *         not_found_image_id: scalar|null,
 *         user_auth_type?: "json_credentials"|"oauth2", // Default: "json_credentials"
 *         limited_asset_licence_files_count: int, // Number of allowed files for an asset licence with enabled limitation. // Default: 100
 *         image_chunk_config?: array{
 *             min_size: int, // Minimal allowed chunk size
 *             max_size: int, // Maximum allowed chunk size
 *         },
 *     },
 *     distribution_services?: array<string, array{ // Default: []
 *         type: scalar|null,
 *         title: scalar|null,
 *         module: scalar|null,
 *         icon_path?: scalar|null, // Default: ""
 *         redistribute_statuses?: list<scalar|null>,
 *         required_auth?: bool, // Default: false
 *         auth_redirect_url?: scalar|null, // Default: null
 *         use_mock?: bool, // Default: false
 *         mock_options?: list<mixed>,
 *         options?: list<mixed>,
 *     }>,
 *     asset_external_providers?: array<string, array{ // Default: []
 *         title: scalar|null,
 *         provider: scalar|null,
 *         options?: list<mixed>,
 *     }>,
 *     display_title?: array{
 *         image?: array<string, array{ // Default: []
 *             source_property_path: scalar|null,
 *             destination_property_path?: scalar|null, // Default: ""
 *             normalizers?: list<array{ // Default: []
 *                 type: scalar|null,
 *                 options?: list<mixed>,
 *             }>,
 *         }>,
 *         audio?: array<string, array{ // Default: []
 *             source_property_path: scalar|null,
 *             destination_property_path?: scalar|null, // Default: ""
 *             normalizers?: list<array{ // Default: []
 *                 type: scalar|null,
 ...
 *             }>,
 *         }>,
 *         video?: array<string, array{ // Default: []
 *             source_property_path: scalar|null,
 *             destination_property_path?: scalar|null, // Default: ""
 *             normalizers?: list<array{ // Default: []
 *                 type: scalar|null,
 ...
 *         }>,
 *     },
 *     ext_systems?: array<string, array{ // Default: []
 *         id?: scalar|null,
 *         ext_storage?: scalar|null,
 *         asset_external_providers?: array<string, array{ // Default: []
 *             title?: scalar|null,
 *             import_author_id?: scalar|null,
 *         }>,
 *         image?: array{
 *             distribution?: array{
 *                 distribution_services?: list<scalar|null>,
 *                 distribution_requirements?: array<string, array{ // Default: []
 *                     title?: scalar|null,
 *                     blocked_by?: list<scalar|null>,
 *                     category_select?: bool|array{
 *                         enabled?: bool, // Default: false
 *                         required?: bool, // Default: false
 *                     },
 *                     strategy: scalar|null, // Default: "none"
 *                     distribution_metadata_map?: array<string, array{ // Default: []
 *                         source_property_path: scalar|null,
 *                         destination_property_path?: scalar|null, // Default: ""
 *                         normalizers?: list<array{ // Default: []
 *                             type: scalar|null,
 ...
 *             },
 *             enabled?: bool, // Default: false
 *             storage_name: scalar|null,
 *             chunk_storage_name: scalar|null,
 *             title: list<scalar|null>,
 *             size_limit: int,
 *             custom_metadata_pinned_amount?: int, // Default: 5
 *             mime_types?: list<scalar|null>,
 *             file_slots: array{
 *                 default?: scalar|null, // Default: "default"
 *                 slots?: list<scalar|null>,
 *             },
 *             keywords?: bool|array{
 *                 enabled?: bool, // Default: false
 *                 required?: bool, // Default: false
 *                 autocomplete_from_exif_metadata_tags?: array<string, scalar|null>,
 *             },
 *             authors?: bool|array{
 *                 enabled?: bool, // Default: false
 *                 required?: bool, // Default: false
 *                 autocomplete_from_exif_metadata_tags?: array<string, scalar|null>,
 *             },
 *             asset_external_providers_map?: array<string, array{ // Default: []
 *                 source_property_path: scalar|null,
 *                 destination_property_path?: scalar|null, // Default: ""
 *                 normalizers?: list<array{ // Default: []
 *                     type: scalar|null,
 ...
 *                 }>,
 *             }>,
 *             public_domain: scalar|null,
 *             admin_domain: scalar|null,
 *             roi_width: scalar|null,
 *             roi_height: scalar|null,
 *             crop_storage_name: scalar|null,
 *         },
 *         audio?: array{
 *             distribution?: array{
 *                 distribution_services?: list<scalar|null>,
 ...
 *                 autocomplete_from_exif_metadata_tags?: array<string, scalar|null>,
 *             },
 *             public_storage?: scalar|null,
 *             public_domain_name?: scalar|null,
 *             podcast_episode_rss_map?: array<string, array{ // Default: []
 *                 source_property_path: scalar|null,
 *                 destination_property_path?: scalar|null, // Default: ""
 *                 normalizers?: list<array{ // Default: []
 *                     type: scalar|null,
 ...
 *                 }>,
 *             }>,
 *             podcast_episode_entity_map?: array<string, array{ // Default: []
 *                 source_property_path: scalar|null,
 *                 destination_property_path?: scalar|null, // Default: ""
 *                 normalizers?: list<array{ // Default: []
 *                     type: scalar|null,
 ...
 *                 }>,
 *             }>,
 *             video_episode_entity_map?: array<string, array{ // Default: []
 *                 source_property_path: scalar|null,
 *                 destination_property_path?: scalar|null, // Default: ""
 *                 normalizers?: list<array{ // Default: []
 *                     type: scalar|null,
 ...
 *         tmp_dir_path: scalar|null, // Path to directory, used for file operations (merge chunks etc.)
 *         fixtures_dir_path: scalar|null, // Path to directory, used for generating image fixtures
 *     },
 *     image_settings?: array{
 *         optimal_resizes: list<scalar|null>,
 *         color_set?: array<string, array{ // Default: []
 *             rgb?: list<scalar|null>,
 *         }>,
 *         enable_crop_cache?: bool, // Default: true
 *         crop_allow_map?: array<string, array{ // Default: []
 *             crop_allow_list: scalar|null,
 *             domain: scalar|null,
 *             ext_system_slugs?: list<scalar|null>,
 *         }>,
 *         crop_allow_list?: array<string, array{ // Default: []
 *             quality_whitelist?: list<scalar|null>,
 *             crops?: list<array{ // Default: []
 *                 width?: int,
 *                 height?: int,
 *                 tags?: list<scalar|null>,
 ...
 *         }>,
 *     },
 *     domains?: array<string, array{ // Default: []
 *         domain?: scalar|null,
 *         max_age?: scalar|null, // Default: 0
 *         cache_ttl?: scalar|null, // Default: 0
 *         public?: bool, // Default: false
 *         must_revalidate?: bool, // Default: false
 *     }>,
 *     exif_metadata?: array{
 *         common_metadata?: array<string, array{ // Default: []
 *             autoFillField?: scalar|null, // Default: true
 *         }>,
 *         image_metadata?: array<string, array{ // Default: []
 *             autoFillField?: scalar|null, // Default: true
 *         }>,
 *     },
 ...
 *         fallback_storage?: scalar|null, // Default: ""
 *         options?: list<mixed>,
 *     }>,
 * }
 * @psalm-type AnzuSystemsCommonConfig = array{
 *     settings?: array{
 *         app_redis?: scalar|null,
 *         app_cache_proxy_enabled?: scalar|null, // Default: true
 *         user_entity_class?: scalar|null, // Default: "App\\Entity\\User"
 *         app_entity_namespace?: scalar|null, // Default: "App\\Entity"
 *         app_value_object_namespace?: scalar|null, // Default: "App\\Model\\ValueObject"
 *         app_enum_namespace?: scalar|null, // Default: "App\\Model\\Enum"
 *         mongo_query_max_time_ms?: int, // Default: 3000
 *         send_context_id_with_response?: bool, // Default: false
 *         unlocked_commands?: list<scalar|null>,
 *     },
 *     errors?: bool|array{
 *         enabled?: bool, // Default: true
 *         only_uri_match?: list<scalar|null>,
 *         default_exception_handler?: scalar|null, // Default: "AnzuSystems\\CommonBundle\\Exception\\Handler\\DefaultExceptionHandler"
 *         exception_handlers?: list<scalar|null>,
 *     },
 *     logs?: bool|array{
 *         enabled?: bool, // Default: true
 *         messenger_transport?: array{
 *             name: scalar|null,
 *             dsn: scalar|null,
 *         },
 *         app?: array{
 *             ignored_exceptions?: list<scalar|null>,
 *         },
 *         journal?: array{
 *             mongo?: array{
 *                 uri: scalar|null,
 ...
 *                 ssl?: scalar|null, // Default: false
 *                 collection?: scalar|null, // Default: "appLogs"
 *             },
 *         },
 *         audit?: array{
 *             mongo?: array{
 ...
 *                 database: scalar|null,
 *                 ssl?: scalar|null, // Default: false
 *                 collection?: scalar|null, // Default: "auditLogs"
 *             },
 *             logged_methods?: list<scalar|null>,
 *         },
 *     },
 *     health_check?: bool|array{
 *         enabled?: bool, // Default: true
 *         mysql_table_name?: scalar|null, // Default: "_doctrine_migration_versions"
 *         mongo_collections?: list<scalar|null>,
 *         modules?: list<scalar|null>,
 *     },
 *     permissions?: bool|array{
 *         enabled?: bool, // Default: true
 *         default_grants?: list<int>,
 *         roles?: list<scalar|null>,
 *         config?: list<array<string, array<string, array<string, scalar|null>>>>,
 *         translation?: array{
 *             subjects?: list<array<string, scalar|null>>,
 *             actions?: list<array<string, scalar|null>>,
 *             roles?: list<array<string, scalar|null>>,
 *         },
 *     },
 *     jobs?: array{
 *         max_exec_time?: scalar|null, // Default: 50
 *         max_memory?: scalar|null, // Default: 100000000
 *         no_job_idle_time?: scalar|null, // Default: 10
 *     },
 *     editors?: array<string, array{ // Default: []
 *         node_transformer_provider_class?: scalar|null, // Default: "AnzuSystems\\CommonBundle\\AnzuTap\\TransformerProvider\\AnzuTapNodeTransformerProvider"
 *         body_preprocessor?: scalar|null, // Default: "AnzuSystems\\CommonBundle\\AnzuTap\\AnzuTapBodyPreprocessor"
 *         body_postprocessor?: scalar|null, // Default: "AnzuSystems\\CommonBundle\\AnzuTap\\AnzuTapBodyPostprocessor"
 *         node_default_transformer?: scalar|null, // Default: "AnzuSystems\\CommonBundle\\AnzuTap\\Transformer\\Node\\XRemoveTransformer"
 *         mark_transformer_provider_class?: scalar|null, // Default: "AnzuSystems\\CommonBundle\\AnzuTap\\TransformerProvider\\AnzuTapMarkNodeTransformerProvider"
 *         allowed_node_transformers?: list<scalar|null>,
 *         allowed_mark_transformers?: list<scalar|null>,
 *         remove_nodes?: list<scalar|null>,
 *         skip_nodes?: list<scalar|null>,
 *     }>,
 * }
 * @psalm-type AnzuSystemsAuthConfig = array{
 *     cookie: array{
 *         domain?: scalar|null, // Default: null
 *         same_site?: scalar|null, // SameSite attribute for cookies (lax, strict, none or null) // Default: "strict"
 *         secure: bool,
 *         device_id_name?: scalar|null, // Default: "anz_di"
 *         jwt?: array{
 *             payload_part_name: scalar|null, // Default: "anz_jp"
 *             signature_part_name: scalar|null, // Default: "anz_js"
 *         },
 *         refresh_token?: array{
 *             lifetime?: int, // Default: 31536000
 *             name?: scalar|null, // Default: "anz_rt"
 *             existence_name?: scalar|null, // Default: "anz_rte"
 *         },
 *     },
 *     jwt: array{
 *         audience?: scalar|null, // Default: "anz"
 *         algorithm?: "ES256"|"RS256", // Default: "ES256"
 *         public_cert: scalar|null,
 *         private_cert: scalar|null,
 *         lifetime?: int, // Default: 3600
 *     },
 *     authorization?: bool|array{
 *         enabled?: bool, // Default: false
 *         type?: "json_credentials"|"oauth2", // Default: "json_credentials"
 *         refresh_token?: array{
 *             storage?: array{
 *                 redis?: array{
 ...
 *             },
 *         },
 *         auth_redirect_default_url: scalar|null,
 *         auth_redirect_query_url_allowed_pattern: scalar|null,
 *         oauth2?: array{
 *             user_repository_service_id?: scalar|null, // Default: ""
 *             state_token_salt?: scalar|null, // Default: "8fa5f03c168bc9ad3063752dbda14714a881beb56cc7cda2f08c940ff2b78b71"
 *             state_token_enabled?: bool, // Default: true
 *             authorize_url?: scalar|null, // Default: ""
 *             access_token_url?: scalar|null, // Default: ""
 *             user_info_url?: scalar|null, // You can use placeholder "{userId}", which will be replaced with user identifier. // Default: ""
 *             user_info_by_email_url?: scalar|null, // You can use placeholder "{userId}", which will be replaced with user email. // Default: ""
 *             access_token_cache?: scalar|null, // A cache for storing access tokens. // Default: "cache.app"
 *             user_info_class?: scalar|null, // Any replacement of the default value class, must extend it. // Default: "AnzuSystems\\AuthBundle\\Model\\SsoUserDto"
 *             redirect_url?: scalar|null, // Default: ""
 *             client_id?: scalar|null, // Default: ""
 *             client_secret?: scalar|null, // Default: ""
 *             public_cert?: scalar|null, // Default: ""
 *             scope_delimiter?: " "|",", // Default: ","
 *             scopes?: list<scalar|null>,
 *             consider_access_token_as_jwt?: bool, // Default: true
 *             auth_method?: "sso_id"|"sso_email", // Default: "sso_id"
 *         },
 *     },
 * }
 ...
 * }
 * @psalm-type AnzuSystemsSerializerConfig = array{
 *     date_format?: scalar|null, // Default: "Y-m-d\\TH:i:s.u\\Z"
 *     parameter_bag?: list<scalar|null>,
 * }
 ...
 *     },
 * }
 * @psalm-type AnzuSystemsAnzutapConfig = array{
 *     editors?: array<string, array{ // Default: []
 *         node_transformer_provider_class?: scalar|null, // Default: "AnzuSystems\\AnzutapBundle\\Node\\TransformerProvider\\NodeTransformerProvider"
 *         body_preprocessor?: scalar|null, // Default: "AnzuSystems\\AnzutapBundle\\Node\\BodyPreprocessor"
 *         body_postprocessor?: scalar|null, // Default: "AnzuSystems\\AnzutapBundle\\Node\\BodyPostprocessor"
 *         node_default_transformer?: scalar|null, // Default: "AnzuSystems\\AnzutapBundle\\Node\\Transformer\\Node\\XSkipTransformer"
 *         mark_transformer_provider_class?: scalar|null, // Default: "AnzuSystems\\AnzutapBundle\\Node\\TransformerProvider\\MarkNodeTransformerProvider"
 *         allowed_node_transformers?: list<scalar|null>,
 *         allowed_mark_transformers?: list<scalar|null>,
 *         allowed_html_renderers?: list<scalar|null>,
 *         remove_nodes?: list<scalar|null>,
 *         skip_nodes?: list<scalar|null>,
 *     }>,
 *     default_editor_name?: scalar|null,
 * }
 * @psalm-type PetitPressGpsMessengerConfig = array{
 *     auth_cache?: scalar|null, // A cache for storing access tokens. // Default: "cache.app"
 *     forced_transport?: "grpc"|"rest", // A forced transport for all messenger transports. // Default: null
 * }
 * @psalm-type CoreDamConfig = array{
 *     media_api?: array{
 *         storage_name: scalar|null,
 *     },
 *     cms_audio_processed_automat?: array{
 *         audio_free_slot_name: scalar|null,
 *         audio_premium_slot_name: scalar|null,
 *         audio_bonus_slot_name: scalar|null,
 *     },
 *     rtmp?: array{
 *         storage_name: scalar|null,
 *         licence_id: int,
 *         keyword_id?: scalar|null,
 *         title_template?: scalar|null,
 *     },
 *     asset_pub_configuration?: array{
 *         metadata_title: scalar|null,
 *         video_allowed_distributions?: list<scalar|null>,
 *     },
 * }
 ...
 *     anzu_systems_core_dam?: AnzuSystemsCoreDamConfig,
 *     anzu_systems_common?: AnzuSystemsCommonConfig,
 *     anzu_systems_auth?: AnzuSystemsAuthConfig,
 *     anzu_systems_serializer?: AnzuSystemsSerializerConfig,
 *     twig?: TwigConfig,
 *     anzu_systems_anzutap?: AnzuSystemsAnzutapConfig,
 *     petit_press_gps_messenger?: PetitPressGpsMessengerConfig,
 *     core_dam?: CoreDamConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
