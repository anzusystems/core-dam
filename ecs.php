...
return ECSConfig::configure()
    ...
    ->withSkip([
        ...
        'PHP_CodeSniffer\Standards\Generic\Sniffs\CodeAnalysis\AssignmentInConditionSniff.FoundInWhileCondition' => [
            ...
            'src/Sitemap/*.php',
            'src/Domain/Notification/NotificationRempMailerFacade.php',
        ],
        ...
        'SlevomatCodingStandard\Sniffs\Classes\ModernClassNameReferenceSniff.ClassNameReferencedViaFunctionCall' => ['src/Validator/EntityValidator.php'],
        'src/Model/Enum/*.php'
    ])
